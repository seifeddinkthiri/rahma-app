        ...
        <div>
          ...
          <div class="flex flex-wrap -mb-8 -mr-6 p-8">
            ...
            <div v-if="husband_form.good == false" class="w-full">
              <div class="flex flex-row flex-nowrap w-full">
                <text-input class="pb-8 pr-6 w-full" id="disease" :error="husband_form.errors.disease" v-model="husband_form.disease" label="مرض مزمن" placeholder="  المرض المزمن هنا" />
                <text-input class="pb-8 pr-6 w-full" id="disability" v-model="husband_form.disability" :error="husband_form.errors.disability" label=" إعاقة" placeholder="الإعاقة هنا" />

                <text-input v-model="husband_form.disability_card_number" :error="husband_form.errors.disability_card_number" class="pb-8 pr-6 w-full lg:w-1/2" label="رقم بطاقة الإعاقة" placeholder="الرقم هنا" />
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div class="flex flex-wrap -mb-8 -mr-6 p-8">
            ...
            <div v-if="wife_form.good == false" class="w-full">
              <div class="flex flex-row flex-nowrap w-full">
                <text-input class="pb-8 pr-6 w-full" id="disease" :error="wife_form.errors.disease" v-model="wife_form.disease" label="مرض مزمن" placeholder="  المرض المزمن هنا" />
                <text-input class="pb-8 pr-6 w-full" id="disability" v-model="wife_form.disability" :error="wife_form.errors.disability" label=" إعاقة" placeholder="الإعاقة هنا" />

                <text-input v-model="wife_form.disability_card_number" :error="wife_form.errors.disability_card_number" class="pb-8 pr-6 w-full lg:w-1/2" label="رقم بطاقة الإعاقة" placeholder="الرقم هنا" />
              </div>
            </div>
          </div>
          <div class="flex items-center justify-end px-8 py-4 bg-gray-50 border-t border-gray-100">
        ...
        <div>
          ...
          <div class="flex flex-wrap -mb-8 -mr-6 p-8">
            ...
            <div v-if="member_form.good == false" class="w-full">
              <div class="flex flex-row flex-nowrap w-full">
                <text-input class="pb-8 pr-6 w-full" id="disease" :error="member_form.errors.disease" v-model="member_form.disease" label="مرض مزمن" placeholder="  المرض المزمن هنا" />
                <text-input class="pb-8 pr-6 w-full" id="disability" v-model="member_form.disability" :error="member_form.errors.disability" label=" إعاقة" placeholder="الإعاقة هنا" />

                <text-input v-model="member_form.disability_card_number" :error="member_form.errors.disability_card_number" class="pb-8 pr-6 w-full lg:w-1/2" label="رقم بطاقة الإعاقة" placeholder="الرقم هنا" />
              </div>
            </div>
          </div>
          <div class="flex items-center justify-end px-8 py-4 bg-gray-50 border-t border-gray-100">
